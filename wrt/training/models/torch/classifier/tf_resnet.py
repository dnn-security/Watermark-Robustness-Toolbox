...
""" Wrapper class to convert a resnet trained in tensorflow on Open Images to PyTorch 
"""
...
def subsample(factor):
    if factor == 1:
        ...
        return nn.MaxPool2d(1, stride=factor)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, base_width=64, norm_layer=None):
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        for _ in range(1, blocks - 1):
            layers.append(block(self.inplanes, planes, base_width=self.base_width, norm_layer=norm_layer))
        layers.append(block(self.inplanes, planes, stride=stride, base_width=self.base_width, norm_layer=norm_layer))
